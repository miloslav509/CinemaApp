...
//        adresaDto = toAdresaDto.convert(sacuvanaAdresa);
//        dto.setAdresaDTO(adresaDto);
 ...
 //   @PreAuthorize("permitAll()")
    ...
    @GetMapping("/{username}/karte")
    public ResponseEntity<List<KartaDTO>> getKarte(@PathVariable String username){
    	Korisnik korisnik = korisnikService.findbyKorisnickoIme(username).get();
